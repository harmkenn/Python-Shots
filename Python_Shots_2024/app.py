...
from apps import a_deflection,b_points,c_polar,d_afatds,e_physics,f_sungrid,g_sunnorth,h_celgrid,i_grid_cel,j_jadocs,k_rockets  # import your app modules here
...
app.add_app('Rockets',k_rockets.app)
